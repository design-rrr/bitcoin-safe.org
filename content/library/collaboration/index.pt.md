...
3. 🟢 O Dave assina primeiro usando o seu assinador de hardware [Jade]({{< ref "library/supported-hardware-signers/" >}})
4. 🧑‍💻 O Joe assina com o seu [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) – rápido e fluido
