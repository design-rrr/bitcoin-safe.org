...
3. 🟢 En Dave signa primer utilitzant el seu [Jade]({{< ref "library/supported-hardware-signers/" >}}) signador de maquinari
4. 🧑‍💻 En Joe signa amb el seu [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) — ràpid i fluid
