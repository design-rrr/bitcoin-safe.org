...
3. 🟢 Dave 首先使用他的 [Jade]({{< ref "library/supported-hardware-signers/" >}}) 硬件签名器签名
4. 🧑‍💻 Joe 使用他的 [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) 签名 —— 快速且顺畅
