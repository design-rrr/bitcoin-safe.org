...
3. 🟢 Dave podpisuje pierwszy, używając swojego podpisywacza sprzętowego [Jade]({{< ref "library/supported-hardware-signers/" >}})
4. 🧑‍💻 Joe podpisuje swoim [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) – szybko i płynnie
