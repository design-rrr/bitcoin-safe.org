...
3. 🟢 Dave signiert zuerst mit seinem [Jade]({{< ref "library/supported-hardware-signers/" >}}) Hardware-Signer
4. 🧑‍💻 Joe signiert mit seiner [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) – schnell und reibungslos
