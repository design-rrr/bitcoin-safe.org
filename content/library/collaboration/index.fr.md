...
3. 🟢 Dave signe en premier avec son signataire matériel [Jade]({{< ref "library/supported-hardware-signers/" >}})
4. 🧑‍💻 Joe signe avec son [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) – rapide et fluide
