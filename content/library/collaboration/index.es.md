...
3. 🟢 Dave firma primero usando su firmador de hardware [Jade]({{< ref "library/supported-hardware-signers/" >}})
4. 🧑‍💻 Joe firma con su [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) – rápido y fluido
