...
3. 🟢 Dave firma per primo usando il suo firmatore hardware [Jade]({{< ref "library/supported-hardware-signers/" >}})  
4. 🧑‍💻 Joe firma con il suo [BitBox02]({{< ref "library/supported-hardware-signers/" >}}) – veloce e fluido  
