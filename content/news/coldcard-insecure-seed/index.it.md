...
1. Su un **dispositivo di firma diverso da COLDCARD** ([vedi i dispositivi supportati]({{< ref "library/supported-hardware-signers" >}})), crea un wallet completamente nuovo con la procedura guidata di Bitcoin-Safe: scegli un [wallet a firma singola]({{< ref "library/setup-singlesig-wallet" >}}) oppure un [wallet multifirma]({{< ref "library/setup-multisig-wallet" >}}). Non riutilizzare il vecchio seed.
