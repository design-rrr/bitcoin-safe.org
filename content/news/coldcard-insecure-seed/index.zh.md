...
2. 签署迁移交易：
   - **如果受影响的钱包是单签钱包：** 使用较高的手续费按常规方式广播，以便尽快确认。
   - **如果受影响的钱包是多签钱包：** 不要按常规方式广播，因为这会在公共 mempool 中暴露其公钥。复制已签名的 raw transaction，并通过 [MARA Slipstream](https://slipstream.mara.com/) 直接提交。
