...
1. En un **dispositivo de firma que no sea COLDCARD** ([ver dispositivos compatibles]({{< ref "library/supported-hardware-signers" >}})), crea una wallet completamente nueva con el asistente de configuración de Bitcoin-Safe: elige una [wallet de firma única]({{< ref "library/setup-singlesig-wallet" >}}) o una [wallet multifirma]({{< ref "library/setup-multisig-wallet" >}}). No reutilices la seed antigua.
